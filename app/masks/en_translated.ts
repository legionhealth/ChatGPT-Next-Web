...
export const EN_TRANSLATED_MASKS: BuiltinMask[] = [
  {
    avatar: "1f5bc-fe0f",
  ...
  },
  {
    ...
    context: [
      ...
      {
        role: "assistant",
        content: "Okay, which profession do you need me to write a general resume for?",
        date: "",
      },
    ],
    modelConfig: {
